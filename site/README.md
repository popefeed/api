...
The PopeFeed Site is a static website built with Hugo that presents papal documents in an engaging, Instagram/LinkedIn-style social feed. It consumes data from the [PopeFeed API](https://github.com/popefeed/api) which is generated by the [PopeFeed Scrapper](https://github.com/popefeed/scrapper).
...
- Access to PopeFeed API (local or remote)
...
[params]
  api_base_url = "http://localhost:8000"  # PopeFeed API URL
  site_title = "PopeFeed"
...
The site fetches data from the PopeFeed API:
...
The site consumes data from the [PopeFeed API](https://github.com/popefeed/api):
...
The site displays data generated by the [PopeFeed Scrapper](https://github.com/popefeed/scrapper):
...
- **[PopeFeed API](https://github.com/popefeed/api)** - Backend API serving document data
- **[PopeFeed Scrapper](https://github.com/popefeed/scrapper)** - Generates the API data
...
- **PopeFeed API**: Generated document data
